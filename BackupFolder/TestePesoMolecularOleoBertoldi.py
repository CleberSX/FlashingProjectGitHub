...
from Data_pkg.GeometricData_pkg.input_pipe_data import input_pipe_data_function as pipe
from Data_pkg.GeometricData_pkg.input_pipe_data import areaVenturiPipe_function as Area
from Data_pkg.FlowData_pkg.input_flow_data import input_flow_data_function
...
visc_mixture_in = FlowTools_obj.liquidViscosity_Wrap(p_e, T_e, xRe, xRe_mass,'jpDias')
...
viscPOE_in = FlowTools_obj.liquidPhaseDensity_jpDias_SEC(T_e,p_e,([0.0, 1.0]))
viscR_in = PropsSI("V", "T", T_e, "P", p_e,"R134a")
print('\n============================================================ \n')
...
for j, p in enumerate(p_vector):
    mu_r134a[j] = PropsSI("V", "T", T_e, "P", p,"R134a")
